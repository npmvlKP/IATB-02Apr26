...
@pytest.mark.parametrize(
    "timestamp_input",
    [
        datetime(2024, 1, 1, 9, 30, tzinfo=UTC),  # datetime aware
        1_704_097_800,  # unix timestamp (seconds)
        "2024-01-01T09:30:00+00:00",  # ISO string
    ],
)
def test_normalize_valid_ohlcv_record(timestamp_input, mock_helpers):
    ...
    assert bar.timestamp == create_timestamp(datetime(2024, 1, 1, 9, 30, tzinfo=UTC))
